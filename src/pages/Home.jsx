            ...
            <div className="w3-main">
                ...
                <div 
                    ...
                    <div className="w3-twothird w3-container">
                        ...
                        <li>
                            A ChatGPT client on hosting on <s>a raspberry pi 4B</s> AWS EC2 which is built
                            on top of an
                            <a href="https://github.com/ChatGPTNextWeb/ChatGPT-Next-Web"
                            >open source project</a
                            >, allowing myself and my friend to pay much less for LLM
                            providers&apos; (OpenAPI, Gemini, XAi) latest models.
                        </li>
                        <li>AWS EC2, Docker + Next.js</li>
                        </ul>

                        <a href="images/crossgpt/demo.png" target="_blank"
                        ><img className="showcase" src="images/crossgpt/demo.png" width="65%"
                        /></a>
                        <br /><br />
                        <hr />
                        ...
                        <h3><i>Ride Sharing App for Hong Kong (React Native App)</i></h3>
                        <ul>
                        <li>
                            <a
                            ...
                            >
                            /
                            <a href="https://i.cs.hku.hk/fyp/2018/fyp18028/" target="_blank"
                            >Homepage link</a
                            >
                        </li>
                        ...
                        ><img className="showcase" src="images/gogocoach/1.png" width="20%"
                        /></a>
                        <a href="images/gogocoach/2.png" target="_blank"
                        ><img className="showcase" src="images/gogocoach/2.png" width="20%"
                        /></a>
                        <a href="images/gogocoach/3.png" target="_blank"
                        ><img className="showcase" src="images/gogocoach/3.png" width="20%"
                        /></a>
                        <a href="images/gogocoach/4.png" target="_blank"
                        ><img className="showcase" src="images/gogocoach/4.png" width="21%"
                        /></a>
                        <br /><br />
                    </div>
                    </div>
